...
OOPPTTIIOONNSS
       ...
       <refspec>...
           ...
           arbitrary "SHA-1 expression", such as master~4 or HEAD (see ggiittrreevviissiioonnss(7)).
           ...
           default (e.g., it is not a fast-forward.) This does nnoott attempt to merge <src> into
       ...
       --follow-tags
           ...
           configuration variable _p_u_s_h_._f_o_l_l_o_w_T_a_g_s. For more information, see _p_u_s_h_._f_o_l_l_o_w_T_a_g_s in
       ...
       --[no-]signed, --sign=(true|false|if-asked)
           ...
           pushes. The push will also fail if the actual call to gpg --sign fails. See ggiitt--
       ...
       --receive-pack=<git-receive-pack>, --exec=<git-receive-pack>
           Path to the _g_i_t_-_r_e_c_e_i_v_e_-_p_a_c_k program on the remote end. Sometimes useful when pushing
       ...
       -u, --set-upstream
           ...
           see _b_r_a_n_c_h_._<_n_a_m_e_>_._m_e_r_g_e in ggiitt--ccoonnffiigg(1).

       --[no-]thin
           These options are passed to ggiitt--sseenndd--ppaacckk(1). A thin transfer significantly reduces
       ...
       --no-recurse-submodules, --recurse-submodules=check|on-demand|no
           ...
           revisions it will also be aborted and exit with non-zero status. A value of _n_o or
           using _-_-_n_o_-_r_e_c_u_r_s_e_-_s_u_b_m_o_d_u_l_e_s can be used to override the push.recurseSubmodules
...
GGIITT UURRLLSS
       ...
       _r_e_m_o_t_e_-_<_t_r_a_n_s_p_o_r_t_> remote helper, if one exists. To explicitly request a remote helper,
       the following syntax may be used:

       ·   <transport>::<address>

       where <address> may be a path, a server and path, or an arbitrary URL-like string
       recognized by the specific remote helper being invoked. See ggiittrreemmoottee--hheellppeerrss(1) for
       details.
...
RREEMMOOTTEESS
   ...
   NNaammeedd rreemmoottee iinn ccoonnffiigguurraattiioonn ffiillee
       ...
       ggiitt--rreemmoottee(1), ggiitt--ccoonnffiigg(1) or even by a manual edit to the $GIT_DIR/config file. The URL
   ...
   NNaammeedd ffiillee iinn $$GGIITT__DDIIRR//rreemmootteess
       ...
       Push: lines are used by _g_i_t _p_u_s_h and Pull: lines are used by _g_i_t _p_u_l_l and _g_i_t _f_e_t_c_h.
...
OOUUTTPPUUTT
       ...
       summary
           ...
           remote rejected
               ...
               receive.denyDeletes or receive.denyDeleteCurrent. See ggiitt--ccoonnffiigg(1).
...
NNOOTTEE AABBOOUUTT FFAASSTT--FFOORRWWAARRDDSS
       ...
       commit B. This does _n_o_t fast-forward. If you did so, the changes introduced by commit A
...
Git 2.7.4                                   06/05/2018                                GIT-PUSH(1)
